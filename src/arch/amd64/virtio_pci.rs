//! amd64 virtio transport: legacy (0.9.5) virtio-pci over port I/O.
//!
...
impl VirtioLegacy {
    ...
    pub fn new(dev: &super::pci::PciDevice) -> Option<Self> {
        let io = dev.io_base()?;
...
pub fn init(devices: &[super::pci::PciDevice]) {
    for dev in devices {
...
");
        ...
        match VirtioLegacy::new(dev) {
            ...
            None => crate::serial::write_line("[VIRTIO] device has no I/O BAR — skipped"),
        }
    }
}
